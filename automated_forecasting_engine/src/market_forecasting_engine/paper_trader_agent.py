...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--enable-llm-decision", action="store_true", default=True, help="Use a cached forecast-time LLM decision as the final trade intent. Enabled by default.")
    parser.add_argument("--disable-llm-decision", action="store_false", dest="enable_llm_decision", help="Disable the default cached forecast-time LLM decision layer.")
